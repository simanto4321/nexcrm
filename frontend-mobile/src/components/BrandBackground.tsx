...
export function BrandBackground({ children, style }: { children: ReactNode; style?: ViewStyle }) {
  return (
    <View style={[styles.root, style]}>
      <LinearGradient
        colors={['#0a1020', '#101a33', '#1a0a12', '#070b16']}
...
const styles = StyleSheet.create({
  ...
  mark1: { fontSize: 78, top: '16%', left: 12, transform: [{ rotate: '-12deg' }], color: 'rgba(255,255,255,0.07)' },
  mark2: { fontSize: 68, bottom: '20%', right: -8, transform: [{ rotate: '8deg' }], color: 'rgba(255,255,255,0.06)' },
  mark3: { fontSize: 170, top: '38%', left: '26%', color: 'rgba(228,37,39,0.09)' },
})
