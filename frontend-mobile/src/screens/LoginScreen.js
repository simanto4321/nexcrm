      ...
      flex: 1
        ...
        <ScrollView contentContainerStyle={styles.wrap} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.card}>
            ...
            <PrimaryButton label={busy ? 'Signing in…' : 'Sign In'} onPress={onSubmit} disabled={busy} emoji={featureEmoji.login} />
            <GhostButton label="Create a workspace" emoji={featureEmoji.signup} onPress={() => navigation.navigate('Signup')} />
          ...
          <View style={styles.features}>
            {[`${featureEmoji.contacts} Contacts`, `${featureEmoji.deals} Pipeline`, `${featureEmoji.telegram} Telegram`, `${featureEmoji.ai} AI Assistant`].map(f => <Text key={f} style={styles.featureChip}>
                {f}
              </Text>)}
          </View>
        </ScrollView>
