...
export function AuthShell({
  ...
  return <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="absolute bottom-20 right-0 w-96 h-96 rounded-full bg-cyan-500/20 blur-3xl animate-float" style={{
        animationDelay: '2s'
      }} />
        ...
        <div className="relative z-10 space-y-6 max-w-md">
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            {['AI Chatbot', 'Kanban Pipeline', 'Telegram Bot', 'Email Alerts'].map(f => <span key={f} className="glass px-3 py-1.5 rounded-full text-xs font-medium text-slate-200">
                {f}
              </span>)}
          </div>
        </div>
...
export function AuthFooterLink({
  ...
  return <p className="text-center text-sm text-slate-400">
