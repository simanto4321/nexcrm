...
const platformTenants = [{
  ...
  code: 'globex',
  users: 'Sales workspace with contacts, deals & tasks'
}, {
  name: 'Acme Corp',
  code: 'acme',
  users: 'Sales workspace with contacts, deals & tasks'
  ...
  return <div className="min-h-screen deep-bg text-white">
      ...
      <section className="py-12 landing-section-deep">
        ...
        <div className="max-w-4xl mx-auto flex flex-wrap justify-center gap-x-12 gap-y-4 px-4">
          {logos.map(name => <span key={name} className="text-lg font-bold text-slate-600 tracking-wide">{name}</span>)}
        </div>
      </section>
      ...
      <section id="features" className="py-24 px-4 scroll-mt-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {features.map(f => <div key={f.title} className="feature-tile text-[#313949]">
      ...
      <section id="integrations" className="py-24 px-4 scroll-mt-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-10">
            {integrations.map(item => <div key={item.name} className="glass-card p-8">
      ...
      <section id="platform" className="py-24 px-4 landing-section-deep scroll-mt-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-10">
            {platformTenants.map(t => <div key={t.code} className="feature-tile text-[#313949]">
